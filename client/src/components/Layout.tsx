  ...
  return (
    <SidebarProvider defaultOpen>
      <div className="flex min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
        <Sidebar className="fixed inset-y-0 left-0 border-r border-gray-200 bg-white/80 backdrop-blur-lg z-50">
          <SidebarHeader>
            <motion.div 
                ...
                <SidebarMenuItem>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <Link href="/workflow-automation" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-50">
                ...
                <SidebarMenuItem>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <Link href="/vault" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-50">
                ...
                <SidebarMenuItem>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <Link href="/reports" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-50">
