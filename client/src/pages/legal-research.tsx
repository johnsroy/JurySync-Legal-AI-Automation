...
import { Gavel, LogOut, Loader2, Book, Search, FileText } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-6">
            <Card className="bg-white/80 backdrop-blur-lg">
              <CardContent className="p-8">
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Start Legal Research</h3>
                  <p className="text-gray-600 text-center mb-6">
                    Search and analyze legal databases, case law, and precedents
                  </p>
            ...
            <Card className="bg-white/80 backdrop-blur-lg">
              ...
              <CardContent>
                <p className="text-gray-600">No research queries performed yet.</p>
              </CardContent>
            </Card>
          </div>
        </div>
